...
# from utils.read_responses import get_all_profiles, id_the_responses, get_question_and_answer
...
# test_path = "source//api/session//session_10"
# update_profiles(test_path, new_session=True)