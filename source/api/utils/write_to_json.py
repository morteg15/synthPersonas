...
#     content = "act as the person described here:\n" + profile
#     return {
#         "model": "gpt-3.5-turbo",
...
#     print(f"Initial messages for {len(all_data)} backgrounds added to output.jsonl")
...
#             all_data[i] = append_message_to_json(all_data[i], text)

#         with open("output.jsonl", "w") as file:
#             for data in all_data:
#                 file.write(json.dumps(data) + '\n')
#         print("Message appended to all JSONs in output.jsonl")
